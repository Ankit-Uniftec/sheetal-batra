...
//   const order = location.state?.orderPayload; // from Screen4
...
//   // Load profile for Contact + Delivery
...
//       // Salesperson
//       salesperson: selectedSP ? selectedSP.salesperson : null,
//       salesperson_phone: selectedSP ? selectedSP.phone : null,
//       salesperson_email: selectedSP ? selectedSP.email : null,
...
//           <select onChange={(e) => handleSPChange(e.target.value)}>
...
//           {selectedSP && (
//             <>
//               <p>Email: {selectedSP.email}</p>
//               <p>Phone: {selectedSP.phone}</p>
//             </>
//           )}
//         </div>
...
//         {/* SUBMIT ORDER */}
//         <button className="continue-btn" onClick={confirmOrder}>
