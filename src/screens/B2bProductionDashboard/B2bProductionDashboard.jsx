                ...
                // working Production Manager dashboard fetch.
                {
                    ...
                    while (true) {
                        const { data: cData, error: cErr } = await supabase
                            ...
                            .select("id, order_id, barcode, component_type, component_label, current_stage, previous_stage, item_index, is_outside_wh, vendor_name, vendor_location, vendor_exit_at, stage_updated_at, re_journey_count, stage_pass_counts, is_rework, is_active")
                            .order("created_at", { ascending: false })
