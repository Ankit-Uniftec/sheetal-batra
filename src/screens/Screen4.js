...
//     inputRef.current?.focus();
//   };
//   const isProbablyColor = (val) => {
//     if (!val) return false;
//     const cssNames = ["red", "blue", "green", "black", "white", "pink", "gold", "silver", "yellow", "orange", "brown"];
//     return (
//       cssNames.includes(val.toLowerCase()) ||
//       val.startsWith("#") ||
//       /^[a-zA-Z]+$/.test(val)
//     );
//   };
...
//                     aria-selected={selected}
//                   >
//                     {/* 🎨 SHOW COLOR DOT IF OPTION LOOKS LIKE A COLOR */}
//                     <span style={{ display: "flex", alignItems: "center", gap: "8px" }}>
//                       {isProbablyColor(opt.label) && (
//                         <span
//                           style={{
//                             width: "14px",
//                             height: "14px",
//                             borderRadius: "50%",
//                             backgroundColor: opt.label,
